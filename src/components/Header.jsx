...
const Header = () => {
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center h-full pl-4 pr-4 lg:pl-[50px] lg:pr-[60px]">
        {/* logo */}
        <a href="/">
          <img
            className="w-[140px] h-[75px] lg:w-[188px] lg:h-[100px]"
            src={logo}
            alt=""
          />
        </a>
        ...
        <div
          ...
          } fixed left-0 right-0 bottom-0 z-40 w-full bg-white transition-all duration-300`}
        >
          <NavMobile />
        </div>
